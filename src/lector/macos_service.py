"""macOS Quick Action (Service) installer for Lector.

This module is macOS-specific and provides helpers to install / uninstall
an Automator Quick Action that exposes *Read with Lector · Stop Reading*
in the right-click Services menu.
"""
...
# ``__SHELL_COMMAND__`` is replaced at install time.
...
def uninstall_quick_action() -> Path | None:

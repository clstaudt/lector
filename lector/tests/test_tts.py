...
def test_read_clipboard():
    from lector.utils import read_clipboard
...
def test_read_stdin():
    from lector.utils import read_stdin
...
def test_get_model_paths():
    from lector.tts import get_model_paths
...
def test_model_dir_is_under_home():
    from lector.tts import MODEL_DIR
...
def test_install_macos_quick_action(tmp_path: Path):
    ...
    with (
        ...
        from lector.utils import install_macos_quick_action
